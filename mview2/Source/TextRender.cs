...
namespace mview2
{
    ...
    class TextRender : IDisposable
    {
        ...
        {
           // gfx.FillPie(new SolidBrush(Color.Blue), point.X - 40, point.Y - 40, 80, 80, 0, 45);
           // gfx.FillPie(new SolidBrush(Color.SaddleBrown), point.X - 40, point.Y - 40, 80, 80, 45, 320);
